...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: "@dewlock/agent/tools/get-defi-positions", replacement: src("agent", "tools/get-defi-positions.ts") },
      ...
      { find: "@dewlock/sui/aftermath-quotes", replacement: src("sui", "aftermath-quotes.ts") },
      { find: "@dewlock/sui/build-aggregator-swap", replacement: src("sui", "build-aggregator-swap.ts") },
      { find: "@dewlock/sui/build-aftermath-swap", replacement: src("sui", "build-aftermath-swap.ts") },
      { find: "@dewlock/sui/build-lend", replacement: src("sui", "build-lend.ts") },
      { find: "@dewlock/sui/lending-positions", replacement: src("sui", "lending-positions.ts") },
      { find: "@dewlock/sui/build-limit-order", replacement: src("sui", "deepbook/build-limit-order.ts") },
      { find: "@dewlock/sui/balance-manager", replacement: src("sui", "deepbook/balance-manager.ts") },
      { find: "@dewlock/sui/order-management", replacement: src("sui", "deepbook/order-management.ts") },
      { find: "@dewlock/sui/account-orders", replacement: src("sui", "deepbook/account-orders.ts") },
