/** GithubMark — the GitHub octocat glyph (inherits color via currentColor). Shared by the
 * landing CTA button and the footer link so the mark stays consistent in one place. */
